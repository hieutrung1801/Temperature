...
class clientThread extends Thread {
    ...
    public void run() {
       ...
       */
            ...
            os.println("Please choose Number 1, 2 or 3 to see temperature in cities: 1.Ho Chi Minh, 2.New York, 3.Miami.");
            String subname = is.readLine().trim();
            String name = null;

                if (Objects.equals(subname, "1")) {
                    name = "Ho Chi Minh";
                } else if (Objects.equals(subname, "2")) {
                    name = "New York";
                } else if (Objects.equals(subname, "3")) {
                    name = "Miami";
                }
